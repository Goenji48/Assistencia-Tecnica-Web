		...
		<div class="linha">
			<section>
				...
				<img src="img/artiom-vallat-H-qqp_Eqaww-unsplash.jpg" alt="Gaming PC" id="homeImage">
					<p>ós somos uma equipe especializada em reparo dos mais diversos eletrônicos com problemas.
			...
			<div class="linha">
				<div class="coluna col7 float content-background content-border">
					<section>
						...
						<p>É Muito facil, apenas nos forneça os equipamentos que necessitam de reparo e faremos a manutenção de forma segura e prática.
</p>
